...
<div class="pageCon" ref="noMove">
    ...
    <page-content>
        <div v-for="(item,index) in items.Accountlist" v-if="index<2">
            ...
            <ul class="account">
                ...
                <li class="items-line bor-bottom flex-box">
                    ...
                    <span class="flex-item">{{item.Fenlimit | formatDate("")}}</span>
                </li>
            </ul>
        </div>
        ...
        <a class="items-line bor-bottom dpb toActive" @click="getWeChat()" v-if="isWeChatBrowser">
            <p>积分充值</p>
            <span class="link-arrow icon icon-link"></span>
        </a>
    </page-content>
