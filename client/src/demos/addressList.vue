...
<div class="addrList-con">
    <div class="addrCon">
        ...
        <div v-if="!isEmpty">
            ...
            <button class="addNew" :class="{disabled : isAddNew}" :disabled="isAddNew" @click="addNewAddr()">添加新地址</button>
        </div>
        <!-- 弹窗错误信息 -->
        ...
        <popup class="receiver-msg" title="新增收货地址" ref="p1" closeButtonText="关闭">
            <ul>
                ...
                <li class="items-line bgf bor-bottom">
                    ...
                    <input id="phone" type="text" placeholder="手机号(必填)" maxlength="11" v-model="receiverMsg.phone" pattern="[0-9]*">
                </li>
                <li class="items-line bgf bor-bottom">
                ...
                <li class="items-line bgf bor-bottom">
                    ...
                    <input id="email" type="email" placeholder="邮件(选填)" maxlength="10" v-model="receiverMsg.email">
                </li>
                <li class="bgf">
    ...
    export default {
        ...
        methods:{
            ...
            verifyLength:function(){
                this.isAddNew = this.items.length >=7 ? true : false;
                this.isEmpty = this.items.length >=1 ? false : true;
            }
        }
    }
</script>
