...
<div class="goodsList-page">
    ...
    <div class="page-content">
        <scroll id="scroll" :on-refresh="onRefresh" :on-infinite="onInfinite">
            <div class="bgee clearfix" :class="{ cardList: isCard ,goodsList:isList}">
                ...
                :key="index" v-if="items.length">
                    <img class="img" v-lazy="'/Thumbnail/BusGoodsList' + item.Img" width="124" height="124">
                    <div class="con">
                        <h3 class="tit">
                            {{item.Cname}}
                        </h3>
        ...
        <img class="back-img" :class="{ dpn: isShowBackTop}" src="../assets/img/backtop.png" @click="backTop()">
    </div>
</div>
</template>
<script>
